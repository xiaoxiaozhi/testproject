...
//        if(typedArray!=null){
//            space = typedArray.getInt(R.styleable.SpacingTextView_spacesize, 0);
//            typedArray.recycle();
//        }
//        if(space!=0){
//            letterSpacing = space;
...
//        this.invalidate();
    ...
    private void applyLetterSpacing() {
        ...
        if (builder.toString().length() > 1) {
            for (int i = 1; i < builder.toString().length(); i += 2) {
                finalText.setSpan(new ScaleXSpan(0.001f), i, i + 1, Spannable
    ...
    public class LetterSpacing {
        ...
        public final static float BIGGEST = (float) 0.005;
    }
}
