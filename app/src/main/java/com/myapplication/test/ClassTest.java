...
public class ClassTest {
    public static void main(String... args) {
        ...
        try {
             ...
             */
            T2 t2 = (T2) Class.forName("com.myapplication.test.ClassTest$T2").newInstance();
            //主要是第二个参数。true ，初始化Class对象  false  不初始化Class对象此时相当月T2.class
            Class.forName("com.myapplication.test.ClassTest$T2", true, T2.class.getClassLoader());
        ...
        try {
            ...
            Class.forName("com.myapplication.test.ClassTest$T2");
        } catch (ClassNotFoundException e) {
            e.printStackTrace();
        }
        Class c = T1.class;
